...
kotlin {
    js(IR) {
        ...
        compilations.all {
            compileTaskProvider.configure {
                compilerOptions.moduleName.set("kmatrix-js")
            }
        }
    }

    val xcf = XCFramework("kmatrix")
    listOf(
        iosX64(),
        iosArm64(),
        iosSimulatorArm64(),
    ...
    cocoapods {
        name = "kmatrix"
        version = "0.0.1"
        summary = "kmatrix is Matrix library for Kotlin Multiplatform."
        homepage = "https://github.com/uakihir0/kmatrix"
        authors = "Akihiro Urushihara"
        license = "MIT"
        framework { baseName = "kmatrix" }
    }
...
tasks.configureEach {
    ...
    if (name.contains("assembleKmatrix") && name.contains("XCFramework")) {
